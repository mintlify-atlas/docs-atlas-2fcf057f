...
sidebarTitle: "DNS"
description: "Technitium DNS at 192.168.1.21 provides local name resolution for home.arpa, DNS caching, ad-blocking via blocklists, and split DNS for the homelab."
---
