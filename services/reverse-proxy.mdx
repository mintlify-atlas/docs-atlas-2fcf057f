...
description: "Nginx Proxy Manager at 192.168.1.22 handles reverse proxying for all homelab services, including SSL termination, wildcard certificates, and local domain routing."
---
...
<Steps>
  ...
  <Step title="NPM proxies the request">
    NPM matches the `Host` header against its configured proxy hosts and forwards the request to the correct backend service — in this example, `192.168.1.30:9000` (Portainer).
  </Step>
...
| ------------------- | --------------------------- | ------------------------ |
| Portainer           | `portainer.home.arpa`       | `192.168.1.30:9000`      |
| Dashy               | `dashy.home.arpa`           | `192.168.1.30:4000`      |
| Speedtest Tracker   | `speed.home.arpa`           | `192.168.1.30:8765`      |
| Technitium DNS      | `dns.home.arpa`             | `192.168.1.21:5380`      |
