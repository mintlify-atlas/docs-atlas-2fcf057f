...
sidebarTitle: "VPN"
description: "Tailscale runs as an LXC at 192.168.1.23 and provides secure remote access via a subnet router, allowing access to all homelab services over an encrypted mesh VPN."
---
