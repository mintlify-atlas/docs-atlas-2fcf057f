...
description: "Homelab observability uses Dashy, Speedtest Tracker, and Homelable for active monitoring, with Uptime Kuma, Grafana, and Prometheus planned for Phase 3."
---
